...
class directoryContents {
  ...
  void pushWorkingDir(const std::string& parent); // with this we will add a subdirectory to our dirPath string as we navigate deeper through our file structure
